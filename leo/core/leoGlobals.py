...
from leo.leolib.util import (  # noqa: F401
    ...
    dump_tree,
    enable_gc_debug,
    ensureLeadingNewlines,
    ensureTrailingNewlines,
    es_clickable_link,
    escaped,
    exec_file,
    file_part_pattern,
    findAncestorVnodeByPredicate,
    findGnx,
    findNodeAnywhere,
    findNodeInChildren,
    findNodeInTree,
    ...
    fullPath,
    funcToMethod,
    g_is_directive_pattern,
    g_language_pat,
    g_section_delims_pat,
    g_tabwidth_pat,
    g_unique_message_d,
    getBaseDirectory,
    getDocString,
    ...
    getIvarsDict,
    getLastTracebackFileAndLineNumber,
    getLine,
    getLineAfter,
    getModifiedFiles,
    getTime,
    ...
    is_binary_file,
    is_c_id,
    is_invisible_sentinel,
    is_nl,
    is_sentinel,
    is_special,
    is_unique_class_dict,
    is_ws,
    is_ws_or_nl,
    isascii,
...
class KeyStroke:
    ...
    def isPlainNumPad(self) -> bool:
        return self.isNumPadKey() and len(self.s.replace('Keypad+', '')) == 1
...
def update_directives_pat() -> None:
    ...
    aList = [rf"\b{z}\b" for z in globalDirectiveList if z != 'others']
    pat = "^@(%s)" % "|".join(aList)
...
def guessExternalEditor(c: Cmdr | None = None) -> str:
    ...
    editor = (
        c
        and c.config.getString('external-editor')
        or os.environ.get("LEO_EDITOR")
